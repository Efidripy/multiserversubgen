...
_MESSAGES: dict[str, dict[str, str]] = {
    ...
    "access_choice": {
        "ru": "Выберите удобное действие: скопировать персональную ссылку, показать QR-код, проверить готовность или сменить ссылку.",
        "en": "Choose an action: copy your personal link, show a QR code, check readiness, or replace the link.",
    },
    ...
    "setup_menu": {
        "ru": "Выберите устройство и следуйте инструкции для совместимого приложения. Ссылку или QR-код можно получить отдельной кнопкой «◎ Получить доступ». Не пересылайте их другим людям.",
        "en": "Choose your device and follow the instructions for a compatible app. Get a link or QR code with the separate “◎ Get access” button. Do not forward them to anyone.",
    },
    "setup_guide": {
        "ru": "1. Нажмите название приложения ниже — Telegram откроет его официальный источник.\n2. Установите приложение и выберите импорт по ссылке или QR-коду.\n3. Вернитесь в бот: «◎ Получить доступ» → ссылка или QR-код.\n4. Не пересылайте ссылку или QR-код: это ваш персональный доступ.",
        "en": "1. Tap an app name below — Telegram opens its official source.\n2. Install the app and choose import by URL or QR code.\n3. Return to the bot: “◎ Get access” → link or QR.\n4. Do not forward the link or QR: it is your personal access.",
    },
    ...
    "status_access": {"ru": "<b>Статус доступа:</b> {status}.{traffic}", "en": "<b>Access status:</b> {status}.{traffic}"},
    "traffic_empty": {"ru": "\nДанные о трафике пока не поступали.", "en": "\nTraffic data has not arrived yet."},
    "traffic_known": {"ru": "\n<b>Трафик за всё время:</b> {traffic}.\n<b>Последнее обновление данных:</b> {updated}.", "en": "\n<b>Lifetime traffic:</b> {traffic}.\n<b>Last data update:</b> {updated}."},
    "diagnostics_provisioning": {"ru": "Регистрация ещё не завершилась на всех назначенных нодах. Доступ появится автоматически после успешного завершения всего набора.", "en": "Registration is not complete on every assigned node. Access appears automatically after the entire set completes successfully."},
    "diagnostics_ready": {"ru": "Доступ готов. Можно получить ссылку или QR-код и импортировать его в выбранное приложение.", "en": "Access is ready. Get a link or QR code and import it into your chosen app."},
    "diagnostics_suspended": {"ru": "Доступ приостановлен. Через меню можно отправить сообщение администратору.", "en": "Access is suspended. You can send a message to the administrator from the menu."},
    "diagnostics_other": {"ru": "Сейчас доступ недоступен. Попробуйте позже или откройте помощь.", "en": "Access is unavailable right now. Try later or open Help."},
