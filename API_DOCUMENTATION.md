...
curl -u admin:password https://your-domain.com/my-vpn/api/v1/nodes

# Добавить клиента
curl -u admin:password -X POST https://your-domain.com/my-vpn/api/v1/clients/batch-add \
...
curl -u admin:password https://your-domain.com/my-vpn/api/v1/servers/status

# Получить статистику трафика
curl -u admin:password https://your-domain.com/my-vpn/api/v1/traffic/stats?group_by=client
```
...
BASE_URL = "https://your-domain.com/my-vpn"
