...
**Совместимость:**
- ✅ Старые raw/HMAC-ссылки поддерживаются в режиме миграции
- ✅ При найденной подписке старый URL получает `302` на постоянную opaque-ссылку
- ✅ Новым клиентам выдаются только новые token URL
