...
config_activation_validate_inputs() {
    ...
    local numeric_name
    for numeric_name in SUB_RATE_LIMIT_COUNT SUB_RATE_LIMIT_WINDOW_SEC TRAFFIC_STATS_CACHE_TTL ONLINE_CLIENTS_CACHE_TTL TRAFFIC_STATS_STALE_TTL ONLINE_CLIENTS_STALE_TTL CLIENTS_CACHE_TTL CLIENTS_CACHE_STALE_TTL TRAFFIC_MAX_WORKERS COLLECTOR_BASE_INTERVAL_SEC COLLECTOR_MAX_INTERVAL_SEC COLLECTOR_MAX_PARALLEL AUDIT_QUEUE_BATCH_SIZE; do
...
config_activation_render_service() {
    ...
    python3 - "$template" "$destination" \
        ...
        "TRAFFIC_STATS_CACHE_TTL=$TRAFFIC_STATS_CACHE_TTL" "ONLINE_CLIENTS_CACHE_TTL=$ONLINE_CLIENTS_CACHE_TTL" \
        "TRAFFIC_STATS_STALE_TTL=$TRAFFIC_STATS_STALE_TTL" "ONLINE_CLIENTS_STALE_TTL=$ONLINE_CLIENTS_STALE_TTL" \
