# 🚀 3X-UI Multi-Server Subscription Manager (v2.1)

Автоматизированный инсталлятор для управления подписками с нескольких серверов 3X-UI. Скрипт объединяет пользователей (Email) со всех ваших панелей в единые ссылки подписок, поддерживает Reality (VLESS) и ведет статистику скачиваний.
...
Решение: Убедитесь, что вы открываете ссылку со слэшем на конце: https://ваш-домен.com/my-vpn/. Также проверьте, что в конфиге Nginx блок location не перекрывается другими правилами.
...
Решение: Проверьте, что вы добавили узел в формате https://ip:port/base-path/. Попробуйте зайти в панель 3X-UI с этого же сервера через curl.
